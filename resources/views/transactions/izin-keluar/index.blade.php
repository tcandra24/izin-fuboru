                        ...
                        <div class="d-flex" style="gap: 10px;">
                            <form action="{{ url('/report/izin-keluar/export') }}">
                                <input type="hidden" name="start_date"
                                    value="{{ Request::has('start_date') ? Request::get('start_date') : '' }}" required>
                                <input type="hidden" name="end_date"
                                    value="{{ Request::has('end_date') ? Request::get('end_date') : '' }}" required>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-bottom-0">
                                                    @isset($izin->kembali)
                                                        ...
                                                        @else
                                                            <span class="badge rounded-pill bg-warning text-white fw-bold">Tidak
                                                                Kembali</span>
                                                        @endif
                                                    @else
                                                ...
                                                <td class="border-bottom-0">
                                                    ...
                                                    @elseif($izin->status === 'A')
                                                        <span
                                                            class="badge rounded-pill bg-info text-white fw-bold">Aktif</span>
                                                    @elseif($izin->status === 'C')
                                                        <span
                                                            class="badge rounded-pill bg-info text-white fw-bold">Selesai</span>
                                                    @else
