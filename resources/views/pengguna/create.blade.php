            ...
            <div class="row">
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="mb-3 w-100">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" value="{{ old('nama') }}" aria-describedby="nama">
                        @error('nama')
                ...
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="mb-3 w-100">
                        ...
                        <input type="text" name="jabatan" class="form-control" id="jabatan" value="{{ old('jabatan') }}" aria-describedby="jabatan">
                        @error('jabatan')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="mb-3 w-100">
                        ...
                        <input type="email" name="email" class="form-control" id="noHp" value="{{ old('email') }}" aria-describedby="email">
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 w-100">
                        ...
                        <select name="kode" class="form-control" id="kode" aria-describedby="kode">
                            ...
                            @foreach($penggunaApp AS $pengguna)
                                <option value="{{ $pengguna->kode }}" {{ (int)old('kode') === $pengguna->kode ? 'selected' : '' }}>
                                    {{ $pengguna->nama }}
                                </option>
                            @endforeach
                        </select>
